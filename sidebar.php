 ...
 <form method="POST" action="index.php?p=accomodation&q=<?php echo isset($_GET['q']) ? $_GET['q'] : ''; ?>">
   <div id="sidebarRight-wrap">
     ...
     <div class="row">
       <div class="col-md-10">
         <button class="btn hotelasha-btn  btn-primary btn-sm " name="booknowA" type="submit" id="booknowA">Check Availability </button>
   ...
   <div class="descRoom">
     ...
     <ul class="a">
       ...
       <?php foreach ($cur as $result) { ?>
         <li><a href="index.php?p=rooms&q=<?php echo $result->ROOM; ?>">
