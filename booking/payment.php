...
if (isset($_POST['btnsubmitbooking'])) {
  ...
  for ($i = 0; $i < $count_cart; $i++) {
    ...
    $reservation->ROOMID            = $_SESSION['hotelasha_cart'][$i]['hotelasharoomid'];
    $reservation->ARRIVAL           = date_format(date_create($_SESSION['hotelasha_cart'][$i]['hotelashacheckin']), 'Y-m-d');
    $reservation->DEPARTURE         = date_format(date_create($_SESSION['hotelasha_cart'][$i]['hotelashacheckout']), 'Y-m-d');
    $reservation->RPRICE            = $_SESSION['hotelasha_cart'][$i]['hotelashaprice'];
    ...
    @$tot += $_SESSION['hotelasha_cart'][$i]['hotelashaprice'];
  }

  $item = count($_SESSION['hotelasha_cart']);
          ...
          <tbody>
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo  date_format(date_create($_SESSION['hotelasha_cart'][$i]['hotelashacheckin']), "m/d/Y"); ?></td>
                    <td><?php echo  date_format(date_create($_SESSION['hotelasha_cart'][$i]['hotelashacheckout']), "m/d/Y"); ?></td>
                    <td><?php echo  ' &#8377;' . $result->PRICE; ?></td>
                    <td><?php echo   $_SESSION['hotelasha_cart'][$i]['hotelashaday']; ?></td>
                    <td><?php echo ' &#8377;' .   $_SESSION['hotelasha_cart'][$i]['hotelashaprice']; ?></td>
                  </tr>
            <?php
