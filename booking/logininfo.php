                ...
                <div class="col-md-12">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-6">
                        <label>Arrival:</label>
                        <?php echo  date_format(date_create($_SESSION['hotelasha_cart'][$i]['hotelashacheckin']), "m/d/Y"); ?>
                      </div>

                      <div class="col-md-6">
                        <label>Departure:</label>
                        <?php echo  date_format(date_create($_SESSION['hotelasha_cart'][$i]['hotelashacheckout']), "m/d/Y"); ?>
                      </div>
                      ...
                      <div style="float:right">
                        ...
                        <div class="col-md-12">
                          <label>Days:</label>
                          <?php echo   $_SESSION['hotelasha_cart'][$i]['hotelashaday']; ?>
                        </div>

                        <div class="col-md-12">
                          <label>Total:</label>
                          <?php echo ' &#8369 ' .   $_SESSION['hotelasha_cart'][$i]['hotelashaprice']; ?>
                        </div>
